...
def main() -> None:
    ...
    repeats = args.repeats or int(execution.get("repeats", 3))
    rounds = args.rounds or int(execution.get("rounds", 3))
    n_per_provider = args.n or int(execution.get("candidates_per_round_per_generator", 5))
    ...
    if args.resume:
        ...
        if manifest.get("mode") != {"mock": args.mock, "dock_enabled": not args.no_dock}:
        ...
        manifest = {
            ...
            "mode": {"mock": args.mock, "dock_enabled": not args.no_dock},
            "execution": {
                "repeats": repeats,
                "rounds": rounds,
